...
# setwd("/Users/kasia/Documents/Research/nu/rp-participant-analyses/scripts")

# Read in data & get rid of files missing data for now
data_summary <- read.csv("../data/final-rp-speech-measures.csv")
...
write.csv(data_summary, "../../speech-in-chr-paper/data/preprocessed-analysis-input-rp.csv", quote = FALSE, row.names = FALSE)
## write.csv(data_summary, "../../speech-in-chr-paper/data/preprocessed-analysis-input-partsrm-rp.csv", quote = FALSE, row.names = FALSE)
