...
list_of_directories = ['../../ddk-automatic-acoustic-analysis/FastTrack/Fast Track/chr-pbj-data/female/',
'../../ddk-automatic-acoustic-analysis/FastTrack/Fast Track/chr-pbj-data/male/']
...
# # # Output dataframe
info_to_output.to_csv('../pbj-speech-measures/fasttrack_raw.csv', index = False)
